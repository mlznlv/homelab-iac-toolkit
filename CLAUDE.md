...
- **Project documentation:** the README and its documentation index, the roadmap, architecture, repository design, the ADR index and ADRs 0001–0007, the supported-tool-version and local-validation documentation, the [consumer guide](docs/consuming-the-toolkit.md) covering the single-revision workflow and its contract-level troubleshooting, [`CONTRIBUTING.md`](CONTRIBUTING.md) and [`SECURITY.md`](SECURITY.md).
