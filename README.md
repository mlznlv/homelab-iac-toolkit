...
See the [roadmap](docs/roadmap.md), [architecture](docs/architecture.md), [repository design](docs/repository-design.md), and [Architecture Decision Records](docs/decisions/README.md).
