...
- Debian's unit is bound to the device and carries an empty `[Install]` section, and its udev rule starts it when the device appears: [`qemu-guest-agent.service`](https://salsa.debian.org/qemu-team/qemu/-/blob/104fbbd5f207885b9d6cbc2ff330bb50eeec4390/debian/qemu-guest-agent.service), [`qemu-guest-agent.udev`](https://salsa.debian.org/qemu-team/qemu/-/blob/104fbbd5f207885b9d6cbc2ff330bb50eeec4390/debian/qemu-guest-agent.udev).
