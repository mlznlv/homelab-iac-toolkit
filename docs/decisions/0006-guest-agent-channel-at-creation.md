...
- Debian's unit is bound to the device and carries an empty `[Install]` section, and its udev rule starts it when the device appears: [`qemu-guest-agent.service`](https://sources.debian.org/data/main/q/qemu/1%3A10.0.11%2Bds-0%2Bdeb13u1/debian/qemu-guest-agent.service), [`qemu-guest-agent.udev`](https://sources.debian.org/data/main/q/qemu/1%3A10.0.11%2Bds-0%2Bdeb13u1/debian/qemu-guest-agent.udev).
